    ...
    public class KlimatogrammenInitializer : System.Data.Entity.DropCreateDatabaseAlways<KlimatogrammenContext>
    {
        protected override void Seed(KlimatogrammenContext context)
        {
            try
            {
                ...
                new Neerslag[] { 45, 48, 44, 25, 14, 6, 6, 8, 10, 48, 51, 66 }, DbGeography.FromText("POINT(50.8 4.35)")
                ...
                new Neerslag[] { 17, 51, 140, 180, 220, 162, 70, 102, 254, 296, 111, 25 }, DbGeography.FromText("POINT(50.8 4.35)")
                ...
                new Neerslag[] { 241, 215, 189, 124, 39, 9, 12, 13, 52, 172, 238, 249 }, DbGeography.FromText("POINT(50.8 4.35)")
                ...
                new Neerslag[] { 9, 14, 16, 47, 103, 168, 156, 111, 71, 46, 23, 9 }, DbGeography.FromText("POINT(50.8 4.35)")
                ...
                new Neerslag[] { 9, 30, 29, 65, 220, 149, 155, 197, 344, 242, 48, 10 }, DbGeography.FromText("POINT(50.8 4.35)")
                ...
                new Neerslag[] { 40, 34, 42, 42, 62, 83, 88, 72, 60, 49, 52, 53 }, DbGeography.FromText("POINT(50.8 4.35)")
                ...
                new Neerslag[] { 9, 7, 6, 10, 18, 37, 39, 37, 29, 20, 16, 12 }, DbGeography.FromText("POINT(50.8 4.35)")
                ...
                new Neerslag[] { 4, 4, 5, 5, 5, 7, 25, 23, 14, 11, 6, 5 }, DbGeography.FromText("POINT(50.8 4.35)")
            ) { BeginJaar = 1961, EindJaar = 1990, Locatie = "Barrow, Alaska" });

                vs.VoegKlimatogramToe(new Klimatogram(
                new Temperatuur[] { -2.3, 1.2, 5.4, 9.8, 14.9, 20.6, 25.5, 24.2, 18.4, 11.8, 4.9, -1.3 },
                new Neerslag[] { 28, 31, 49, 54, 46, 24, 21, 22, 33, 37, 33, 36 }, DbGeography.FromText("POINT(50.8 4.35)")
                ...
                new Neerslag[] { 42, 3, 52, 17, 18, 14, 16, 12, 11, 19, 27, 36 }, DbGeography.FromText("POINT(50.8 4.35)")
